 ...
 * 用户数据
 */
class InstallCrud extends Migrator
{
    ...
    {
        /*$this->_create_plugin_crud_config_agent();
        $this->_create_plugin_crud_config_coupon();
        $this->_create_plugin_crud_config_discount();
        $this->_create_plugin_crud_config_level();
        $this->_create_plugin_crud_config_notify();
        $this->_create_plugin_crud_config_poster();
        $this->_create_plugin_crud_config_rebate();
        $this->_create_plugin_crud_express_company();
        $this->_create_plugin_crud_express_template();
        $this->_create_plugin_crud_goods();
        $this->_create_plugin_crud_goods_cate();
        $this->_create_plugin_crud_goods_item();
        $this->_create_plugin_crud_goods_mark();
        $this->_create_plugin_crud_goods_stock();
        $this->_create_plugin_crud_help_feedback();
        $this->_create_plugin_crud_help_problem();
        $this->_create_plugin_crud_help_question();
        $this->_create_plugin_crud_help_question_x();
        $this->_create_plugin_crud_order();
        $this->_create_plugin_crud_order_cart();
        $this->_create_plugin_crud_order_item();
        $this->_create_plugin_crud_order_refund();
        $this->_create_plugin_crud_order_sender();
        $this->_create_plugin_crud_user_action_collect();
        $this->_create_plugin_crud_user_action_comment();
        $this->_create_plugin_crud_user_action_history();
        $this->_create_plugin_crud_user_action_search();
        $this->_create_plugin_crud_user_checkin();
        $this->_create_plugin_crud_user_coupon();
        $this->_create_plugin_crud_user_create();
        $this->_create_plugin_crud_user_rebate();
        $this->_create_plugin_crud_user_recharge();
        $this->_create_plugin_crud_user_relation();
        $this->_create_plugin_crud_user_transfer();*/
        $this->_create_plugin_crud_item();
    }

    /**
     * 创建数据对象
     * @class PluginWemallConfigAgent
     * @table plugin_crud_config_agent
     * @return void
     */
    private function _create_plugin_crud_config_agent()
    {
     ...
     * @table plugin_crud_config_coupon
     * @return void
     */
    private function _create_plugin_crud_config_coupon()
    {
     ...
     * @table plugin_crud_config_discount
     * @return void
     */
    private function _create_plugin_crud_config_discount()
    {
     ...
     * @table plugin_crud_config_level
     * @return void
     */
    private function _create_plugin_crud_config_level()
    {
     ...
     * @table plugin_crud_config_notify
     * @return void
     */
    private function _create_plugin_crud_config_notify()
    {
     ...
     * @table plugin_crud_config_poster
     * @return void
     */
    private function _create_plugin_crud_config_poster()
    {
     ...
     * @table plugin_crud_config_rebate
     * @return void
     */
    private function _create_plugin_crud_config_rebate()
    {
     ...
     * @table plugin_crud_express_company
     * @return void
     */
    private function _create_plugin_crud_express_company()
    {
     ...
     * @table plugin_crud_express_template
     * @return void
     */
    private function _create_plugin_crud_express_template()
    {
     ...
     * @table plugin_crud_goods
     * @return void
     */
    private function _create_plugin_crud_goods()
    {
     ...
     * @table plugin_crud_goods_cate
     * @return void
     */
    private function _create_plugin_crud_goods_cate()
    {
     ...
     * @table plugin_crud_goods_item
     * @return void
     */
    private function _create_plugin_crud_goods_item()
    {
     ...
     * @table plugin_crud_goods_mark
     * @return void
     */
    private function _create_plugin_crud_goods_mark()
    {
     ...
     * @table plugin_crud_goods_stock
     * @return void
     */
    private function _create_plugin_crud_goods_stock()
    {
     ...
     * @table plugin_crud_help_feedback
     * @return void
     */
    private function _create_plugin_crud_help_feedback()
    {
     ...
     * @table plugin_crud_help_problem
     * @return void
     */
    private function _create_plugin_crud_help_problem()
    {
     ...
     * @table plugin_crud_help_question
     * @return void
     */
    private function _create_plugin_crud_help_question()
    {
     ...
     * @table plugin_crud_help_question_x
     * @return void
     */
    private function _create_plugin_crud_help_question_x()
    {
     ...
     * @table plugin_crud_order
     * @return void
     */
    private function _create_plugin_crud_order()
    {
     ...
     * @table plugin_crud_order_cart
     * @return void
     */
    private function _create_plugin_crud_order_cart()
    {
     ...
     * @table plugin_crud_order_item
     * @return void
     */
    private function _create_plugin_crud_order_item()
    {
     ...
     * @table plugin_crud_order_refund
     * @return void
     */
    private function _create_plugin_crud_order_refund()
    {
     ...
     * @table plugin_crud_order_sender
     * @return void
     */
    private function _create_plugin_crud_order_sender()
    {
     ...
     * @table plugin_crud_user_action_collect
     * @return void
     */
    private function _create_plugin_crud_user_action_collect()
    {
     ...
     * @table plugin_crud_user_action_comment
     * @return void
     */
    private function _create_plugin_crud_user_action_comment()
    {
     ...
     * @table plugin_crud_user_action_history
     * @return void
     */
    private function _create_plugin_crud_user_action_history()
    {
     ...
     * @table plugin_crud_user_action_search
     * @return void
     */
    private function _create_plugin_crud_user_action_search()
    {
     ...
     * @table plugin_crud_user_checkin
     * @return void
     */
    private function _create_plugin_crud_user_checkin()
    {
     ...
     * @table plugin_crud_user_coupon
     * @return void
     */
    private function _create_plugin_crud_user_coupon()
    {
     ...
     * @table plugin_crud_user_create
     * @return void
     */
    private function _create_plugin_crud_user_create()
    {
        // 当前数据表
        $table = 'plugin_crud_user_create';
     ...
     * @table plugin_crud_user_rebate
     * @return void
     */
    private function _create_plugin_crud_user_rebate()
    {
     ...
     * @table plugin_crud_user_recharge
     * @return void
     */
    private function _create_plugin_crud_user_recharge()
    {
     ...
     * @table plugin_crud_user_relation
     * @return void
     */
    private function _create_plugin_crud_user_relation()
    {
     ...
     * @table plugin_crud_user_transfer
     * @return void
     */
    private function _create_plugin_crud_user_transfer()
    {
     ...
     * @return void
     */
    private function _create_plugin_crud_item()
    {
        // 当前数据表
        $table = 'plugin_crud_item';
        ...
        // 创建数据表
        $this->table($table, [
            'engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci', 'comment' => '插件-CRUD-表设计',
        ])
            ->addColumn('unid', 'biginteger', ['limit' => 20, 'default' => 0, 'null' => false, 'comment' => '关联用户'])
            ->addColumn('name', 'string', ['limit' => 180, 'default' => '', 'null' => true, 'comment' => '用户姓名'])
            ->addColumn('phone', 'string', ['limit' => 50, 'default' => '', 'null' => true, 'comment' => '手机号码'])
